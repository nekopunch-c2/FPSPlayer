...
public class CameraLook : MonoBehaviour
{
    ...
    private void HandleLadderTransition()
    {
    ...
    private void HandleLadderCameraRotation()
    {
        if (!_isOnLadder)
        {
            _isOnLadder = true;
    ...
    private void HandleDefaultCameraRotation()
    {
        _isOnLadder = false;
